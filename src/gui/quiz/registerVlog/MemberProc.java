...
//        cbJob.setSelectedItem(job);
    ...
    private void createUI(){
        ...
        //직업       
        JLabel bJob = new JLabel("관심분야 : ");
        String[] arrJob = {"Java", "Database", "HTML", "C"};
        cbInterest = new JComboBox(arrJob);
    ...
    public MemberDTO getViewData(){
        ...
        String birth = birth1+birth2+birth3;
        String job = (String)cbInterest.getSelectedItem();
        String gender = "";
        if(rbMan.isSelected()){
            gender = "M";
