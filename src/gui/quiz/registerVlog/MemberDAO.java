...
public class MemberDAO {
  ...
  public MemberDTO getMemberDTO(String id){
      ...
      try {
          ...
          if(rs.next()){
              ...
              dto.setPwd(rs.getString("user_pw"));
              ...
              dto.setIntro(rs.getString("user_intro"));
  ...
  public Vector getMemberList(){
      ...
      try{
          ...
          while(rs.next()){
              ...
              String interest = rs.getString("user_interest");
  ...
  public boolean insertMember(MemberDTO dto){
      ...
      try{
          ...
          String sql = "insert into tb_member(" +
                      "user_id,user_pw,user_name,user_tel,user_addr,user_birth," +
                      "user_interest,user_gender,user_email,user_intro) "+
                      "values(?,?,?,?,?,?,?,?,?,?)";
          ...
          ps.setString(7, dto.getInterest());
  ...
  public boolean updateMember(MemberDTO vMem){
      ...
      try{
          ...
          ps.setString(5, vMem.getInterest());
